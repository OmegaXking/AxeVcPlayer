...
from AxeVcPlayer.config import ARQ_API_KEY
...
from AxeVcPlayer.function.admins import admins as a
...
from AxeVcPlayer.helpers.filters import command, other_filters
    ...
    if not replied:
        if len(m.command) < 2:
            ...
            if match:
                ...
                livelink = query
                photoid = "https://telegra.ph/file/3014076559c063cc0567f.png"
